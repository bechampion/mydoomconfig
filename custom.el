(custom-set-variables
 ...
 '(package-selected-packages
   '(avy nyan-mode vterm transpose-frame spinner rainbow-blocks mixed-pitch markdown-preview-eww markdown-mode lv ivy f ewal-doom-themes dirvish company-fuzzy)))
(custom-set-faces
