...
(custom-set-faces
 ...
 '(org-level-1 ((t (:inherit variable-pitch :extend t :foreground "SkyBlue1" :weight normal :height 1.0))))
 '(org-level-2 ((t (:inherit variable-pitch :extend t :foreground "light green" :height 1.0))))
